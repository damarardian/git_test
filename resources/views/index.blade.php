            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 single-service">
                        <img class="d-block mx-auto img-fluid" src="assets/img/s1.jpg" alt="">
                        <div class="desc">
                    ...
                    <div class="col-md-4 single-service">
                        ...
                        <img class="d-block mx-auto img-fluid" src="assets/img/s2.jpg" alt="">
                    </div>
                    <div class="col-md-4 single-service">
                        <img class="d-block mx-auto img-fluid" src="assets/img/s3.jpg" alt="">
                        <div class="desc">
